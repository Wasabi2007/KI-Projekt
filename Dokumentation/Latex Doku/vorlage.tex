...
%\usepackage[utf8]{inputenc}  % ErmÃ¶glicht Umlaute-Darstellung unter Linux (je nach verwendetem Format)
%-----------------------------------------------------
...
\begingroup
  \renewcommand{\thepage}{Behaviour Tree-Creator mit Testfunktion in Unity}
  \mytitlepage
  \newpage
\endgroup
%--------------------------------------------------------------------------
...
\input{chapters/Elemente}
\input{chapters/Umsetzung}
\input{chapters/Anleitung}
...
%--------------------------------------------------------------------------
\printindex % Index ausdrücken - optional
%--------------------------------------------------------------------------
